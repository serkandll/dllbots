...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/dllbots)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/dllbots
```

A live public deployment of this template is available at [https://dllbots.templates.workers.dev](https://dllbots.templates.workers.dev)
